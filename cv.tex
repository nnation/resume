...
\header{Nathaniel }{Nation}
       {software engineer | \includegraphics[scale=0.1]{images/net.png} \includegraphics[scale=0.1]{images/netcore.png} \includegraphics[scale=0.1]{images/netframework.png} \includegraphics[scale=0.08]{images/CSharp.png} developer}
